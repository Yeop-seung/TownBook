...
const char ssid[] = "subwifi";    // your network SSID (name)
const char pass[] = "enr05778642";         // your network password
  ...
  if (client) {                               // if you get a client,
    while (client.connected()) {              // loop while the client's connected
      if (client.available()) {               // if there's bytes to read from the client,
        ...
        else if (income_AP.indexOf(F("mainServo/0")) != -1) {
          Serial.println("mainServo 0");
          mainServo.write(0);
          delay(100);
        } else if (income_AP.indexOf(F("mainServo/90")) != -1) {
          Serial.println("mainServo 90");
          mainServo.write(90);
          delay(100);
        }
        else if (income_AP.indexOf(F("servo1/0")) != -1) {
          Serial.println("servo1 0");
          servo1.write(0);
          delay(100);
        } else if (income_AP.indexOf(F("servo1/90")) != -1) {
          Serial.println("servo1 90");
          servo1.write(90);
          delay(100);
        } else if (income_AP.indexOf(F("servo2/0")) != -1) {
          Serial.println("servo2 0");
          servo2.write(0);
          delay(100);
        } else if (income_AP.indexOf(F("servo2/90")) != -1) {
