...
public class InitDb {
    ...
    static class InitService {
        ...
        private Book createBook(String bookIsbn, String bookSubject, String bookTitle, int bookVol, String bookAuthor,
